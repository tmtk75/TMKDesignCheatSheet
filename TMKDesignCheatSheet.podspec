#
#  Be sure to run `pod spec lint TMKDesignCheatSheet.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/TMKDesignCheatSheet"
  ...
  s.source       = { :git => "http://github.com/tmtk75/TMKDesignCheatSheet.git", :tag => "0.0.1" }
